...
| **paginas** | Portada, El proyecto, Contacto (`key`: home / proyecto / contacto). En `home`, `heroMedia` es la ruta del video o imagen de portada; varios videos separados por coma hacen crossfade en loop (p. ej. `/media/jabali1.mp4,/media/jabali2.mp4`) |
